...
When firmware changes are pushed to the master branch, an automatic prerelease is created with the built firmware artifacts. These prereleases are tagged with timestamps (e.g., `build-20231013-120000`) and marked as prereleases to distinguish them from official version releases.
